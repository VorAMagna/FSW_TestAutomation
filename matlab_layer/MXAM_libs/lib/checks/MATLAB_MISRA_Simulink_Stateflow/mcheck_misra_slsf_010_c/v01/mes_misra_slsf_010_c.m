% MES check: misra_slsf_010_c - Arithmetic operation order of relational
% operator block.
%
% function [result,cr_items,r_stats] = mes_misra_slsf_010_c(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_slsf_010_c - Arithmetic operation order of relational operator
% block.
% The first input of a relational operator block should be the primary
% variable and the second input the variable or constant that the primary
% variable is compared to.
%
% FAIL CRITERIA:
% ================
%The check analyses each relational operator block in the model.
%
%    Failed: If the source of the first inport is constant and the second inport is not.
%
%The check result is passed if the failed case does not apply.
% ***********************************************************
% Copyright:    Model Engineering Solutions
% Date:         $Date: 2020/07/31 16:04:04CEST $
% Revision:     $Rev: 6115 $
% ***********************************************************

function [result,cr_items,r_stats] = mes_misra_slsf_010_c(varargin)
