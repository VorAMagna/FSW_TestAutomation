% MES check: misra_slsf_052_a - State Labelling - Uniqueness
%
% function [result, cr_items] = mes_misra_slsf_052_a(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes each state label in a state machine.
% Failed: When a state label is not unique within a state machine.
% The check result is passed, if failed case does not apply.
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
function [result, cr_items, r_stats] = mes_misra_slsf_052_a(system, cmd_s)
