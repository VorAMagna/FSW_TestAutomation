% MES check: misra_slsf_050_e - Stateflow Window and Text Appearance - Comment Delimiter
%
% function [result, cr_items] = mes_misra_slsf_050_e(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% DESCRIPTION:
% ==========
% misra_slsf_050_e - Stateflow Window and Text Appearance - Comment Delimiter
%
% PASS/FAIL CRITERIA:
% ===================
% Pass if the State and Transition comments are within the delimiters /* */
% Fail otherwise.
%
% SOLUTION:
% =========
% Use the delimiter /* */ for all the comments in state and transitions
%
% FIX OPERATION:
% ==============
...
function [result, cr_items, r_stats] = mes_misra_slsf_050_e(system,cmd_s)
