% MES check: misra_slsf_034_a - Chart properties - C-like Bitwise Operators
%
% function [result,cr_items,r_stats]=mes_misra_slsf_034_a(system,cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK
% ==========
% misra_slsf_034_a - Stateflow Chart properties
% The option to use "C-like bitwise operators" (& and |) must be enabled
% for all charts.
%
% PASS/FAIL CRITERIA
% ===================
% The check analyzes each chart in the model whose action language is C.
% Failed 1: The chart option 'Enable C-bit operations' is not selected.
% The check result is passed if all failed cases do not apply.
%
% TECHNICAL NOTES
% ===============
% The option 'Enable C-bit operations' is only available in charts whose
% action language is C.
%
% SOLUTION
% ========
% In the chart properties dialog box, select the option 'Enable C-bit
% operations'.
%
% REPAIR OPTION
% =============
% The automatic repair option selects the option 'Enable C-bit operations'. 
%
% ***********************************************************
