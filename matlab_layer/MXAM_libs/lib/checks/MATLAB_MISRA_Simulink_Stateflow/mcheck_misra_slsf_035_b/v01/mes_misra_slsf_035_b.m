% MES check: misra_slsf_035_b - Usage of truth tables in a state machine.
%
% function [result, cr_items] = mes_misra_slsf_035_b(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_035_b - Usage of truth tables in a state machine. 
% Truth tables must not be used. 
%
% Flow charts offer the same functionality as truth tables but also provide 
% animation to assist with debugging 
%
% PASS/FAIL CRITERIA:
% ===================
% A pass is given, if no truth-table has been detected.
%
%
% ***********************************************************
...
function [result, cr_items, r_stats] = mes_misra_slsf_035_b(system,cmd_s)
