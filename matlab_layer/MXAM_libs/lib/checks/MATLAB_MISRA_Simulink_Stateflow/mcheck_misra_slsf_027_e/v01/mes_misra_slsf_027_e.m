...
%
% function [result,cr_items,r_stats]=mes_misra_slsf_027_e(system,cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% mes_misra_slsf_027_e - Signal and bus label usage
%
% E: All signals and busses that originate from inside a reuseable
% subsystem must not belabelled inside the subsystem.
%
% PASS/FAIL CRITERIA:
% ===================
% If the output signal of a reuseable subsystem originate from inside this
% reuseable subsystem and it is named inside this subsystem, a fail will be
% given, otherwise, the subsystem will get a pass.
%
% CHECK PARAMETERS:
% =================
...
function [result,cr_items,r_stats]=mes_misra_slsf_027_e(system,cmd_s) %#ok<INUSD>
