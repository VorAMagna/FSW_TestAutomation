% MES check: misra_slsf_048_b - Default Transitions
%
% function [result, cr_items] = mes_misra_slsf_048_b(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_048_b - The embedded MATLAB block must not be used.
%
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes all Stateflow charts: 
% Failed: If a Stateflow Chart contains an embedded Matlab Function. 
% Passed: If there is no failed result. 
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
function [result, cr_items, r_stats] = mes_misra_slsf_048_b(system,cmd_s)
