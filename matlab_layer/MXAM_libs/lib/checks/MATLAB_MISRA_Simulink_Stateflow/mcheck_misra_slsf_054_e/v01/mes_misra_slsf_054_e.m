% MES check: misra_slsf_054_e - Transition Labelling - Braces
%
% function [result, cr_items] = mes_misra_slsf_054_e(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% Each condition action brace should appear on its own line.
%
% PASS CRITERIA:
% ================
% A fail is given for each brace of transition, which does not appear on
% its own line.
%
% SOLUTION:
% =========
% Put brace in a new line.
% 
% NOTE
% ====
%
...
% Date:         $Date: 2020/07/31 16:04:48CEST $
% Version:      $Rev: 15192 $
% ***********************************************************

function [result, cr_items, r_stats] = mes_misra_slsf_054_e(system, cmd_s)
