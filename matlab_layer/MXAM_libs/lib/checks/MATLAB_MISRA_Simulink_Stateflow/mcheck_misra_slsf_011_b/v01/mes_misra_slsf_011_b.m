% MES check: mes_misra_slsf_011_b - Control flow blocks in Simulink
%
% function [result,cr_items,r_stats]=mes_misra_slsf_011_b(system,cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% GUIDELINE:
% ==========
% Reference: MISRA AC SLSF, Version 1.0, May 2009. 
% Modelling design and style guidelines for the application of Simulink and
% Stateflow
% Guideline ID: MISRA AC SLSF 011
%
% MES CHECK:
% ==========
% mes_misra_slsf_011_b - Control flow blocks in Simulink
%
% When using the 'switch case' block, the 'default case' must be available
% for in the model.
%
% RATIONALE:
% ==========
% All switch case blocks must have a default output to prevent undefined
% states durcing model execution.
% 
% PASS/FAIL CRITERIA:
% ===================
% Each 'switch case' block with parameter 'CaseShowDefault' set to 'on'
% receives a pass.
%
% SOLUTION:
% =========
% Activate option 'Show Default Case'.
%
% ***********************************************************
...
function [result,cr_items,r_stats]=mes_misra_slsf_011_b(system,cmd_s) %#ok<INUSD>
