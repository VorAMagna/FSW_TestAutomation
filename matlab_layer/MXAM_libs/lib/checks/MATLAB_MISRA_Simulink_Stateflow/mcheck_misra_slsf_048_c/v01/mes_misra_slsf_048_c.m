% MES check: misra_slsf_048_c - Stateflow Coding - C Code
%
% function [result, cr_items] = mes_misra_slsf_048_c(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% PASS/FAIL CRITERIA:
% ===================
% The checks analyses the c-code written in the custom code tab of
% configuration parameters dialog of the model 
% Failed -
% if the Custom code tab has any c- code other than Preprocessor statements
% Passed -
% If the custom code tab has only preprocessor statements
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
% Date:       $Date: 2020/07/31 16:04:40CEST $
% Revision:   $Rev: $
% *************************************************************************

function [result, cr_items, r_stats] = mes_misra_slsf_048_c(system,cmd_s)
