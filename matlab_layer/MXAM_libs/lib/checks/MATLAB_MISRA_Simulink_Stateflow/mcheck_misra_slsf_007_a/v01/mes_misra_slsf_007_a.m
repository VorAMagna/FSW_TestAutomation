% MES check: mes_misra_slsf_007 - Initialization
% 
% function [result,cr_items,r_stats] = mes_misra_slsf_007(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% Blocks that have an initialization parameter (e.g. unit delays,
% integrators, outports in conditionally executed subsystem) must define
% explicitly the initialization value
%
% PASS/FAIL CRITERIA:
% ===================
% Each block, that has the property 'InitialCondition' or 'XO', receives 
% a fail, if this option is empty or set to '[]'
%
% ************************************************************************
...
function [result,cr_items,r_stats] = mes_misra_slsf_007_a(system, cmd_s) %#ok<INUSD>
