% MES check: misra_slsf_050_c - Stateflow window and text appearance
%
% function [result, cr_items] = mes_misra_slsf_050_c(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_050_c - All colour and style within Stateflow should use the pre-set “factory” style
% scheme (edit -> style -> schemes -> factory).
%
% PASS/FAIL CRITERIA:
% ===================
% A pass is given, every state has not more than one default transition.
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
function [result, cr_items, r_stats] = mes_misra_slsf_050_c(system,cmd_s)
