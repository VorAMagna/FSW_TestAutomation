% MES check: mes_misra_slsf_043_c - Transitions - Conditional Transitions
%
% function [result, cr_items] = mes_misra_slsf_043_c(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% ==========
% misra_slsf_043_c:
% In all flow-charts and graphical functions, exactly one unconditional transition
% must begin at every junction (except for the last junction). Every decision point
% (junction) must have a default path.
%
% PASS CRITERIA:
% ================
% 
% A pass will be given for junctions that have exactly one out unconditional
% transition or no out transitions.
%
%
% ***********************************************************
...
function [result, cr_items, r_stats] = mes_misra_slsf_043_c(system, cmd_s)
