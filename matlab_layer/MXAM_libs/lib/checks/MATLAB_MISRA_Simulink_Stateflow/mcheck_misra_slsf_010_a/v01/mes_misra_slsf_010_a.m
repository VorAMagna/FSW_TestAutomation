% MES check: misra_slsf_010_a - Arithmetic operation order of sum block.
%
% function [result,cr_items,r_stats] = mes_misra_slsf_010_a(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_slsf_010_a - Arithmetic operation order of sum block.
% The first input of sum block should be positive ('+').
%
% PASS CRITERIA:
% ================
% If the first input of a sub block or TL_Sum block is not '+', a fail will
% be given.
%
% ***********************************************************
...
function [result,cr_items,r_stats] = mes_misra_slsf_010_a(varargin)
