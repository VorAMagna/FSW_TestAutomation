% MES check: misra_slsf_046 - History Junctions are not allowed.
%
% function [result,cr_items,r_stats] = mes_misra_slsf_046(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_slsf_046 - History Junctions should not be used in Stateflow chart.
%
%
% PASS/FAIL CRITERIA:
% ================
% The check analyzes each Stateflow chart in the model:
% Failed 1: There is one or more history junctions in the model.
...
function [result,cr_items,r_stats] = mes_misra_slsf_046_a(varargin)
