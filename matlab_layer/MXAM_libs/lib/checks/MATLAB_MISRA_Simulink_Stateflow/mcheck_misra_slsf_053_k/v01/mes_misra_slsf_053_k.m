%% Check: misra_slsf_053_k - Transition Positioning - Terminating Junction
%
% function [result, cr_items] = mes_misra_slsf_053_k(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_053_k - In all flow-charts and graphical functions, all
% terminating junctions should have only one incoming transition.
%
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes each terminating junction, i.e. each junction which has 
% no outgoing transitions.
% Failed: If the terminating junction has more than one ingoing transition.
...
function [result, cr_items, r_stats] = mes_misra_slsf_053_k(system,cmd_s)
