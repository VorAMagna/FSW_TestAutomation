% MES check: misra_slsf_034_c - Stateflow Chart properties
%
% function [result,cr_items,r_stats]=mes_misra_slsf_034_c(system,cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_slsf_034_c - Stateflow Chart properties
%
% C. Strong data typing must be used with Simulink (The option 'Use strong 
%    data typing with Simulink I/O' is selected).
%
%
% PASS/FAIL CRITERIA:
% ===================
% C. The 'Use Strong Data Typing with Simulink I/O' option in the Chart 
%    Properties dialogs is checked.
% 
% NOTE:
% =====
% Under R2011b, the 'Use Strong Data Typing with Simulink I/O' option is 
% missing 
% 
% SOLUTION
% ========
% Adjust chart properties settings to comply with the guideline.
%
%
% ***********************************************************
