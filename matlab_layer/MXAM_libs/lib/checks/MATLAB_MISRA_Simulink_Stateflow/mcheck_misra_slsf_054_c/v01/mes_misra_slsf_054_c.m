% MES check: misra_slsf_054_c - Transition Labelling - Conditions and Actions
%
% function [result, cr_items] = mes_misra_slsf_054_c(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% DESCRIPTION:
% ==========
% misra_slsf_050_d - All note text should be italic.
%
% PASS/FAIL CRITERIA:
% ===================
% The check inspects every annotation (note) in a Stateflow chart.
% Failed: If the font format (weight) is not set to italic.
% The check result is passed if the failed case does not apply.
%
% SOLUTION:
% =========
% Use the format 'italic' for every annotation (note) in Stateflow charts.
%
% FIX OPERATION:
% ==============
% The repair action sets the format of every annotation (note) to italic.
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
% Date: $Date: 2020/07/31 16:04:47CEST $
% Version: $Rev: 15479 $
% ***********************************************************

function [result,cr_items,r_stats]= mes_misra_slsf_054_c(system,cmd_s)
