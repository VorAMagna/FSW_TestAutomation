% MES check: misra_slsf_042_b - Default Transitions
%
% function [result, cr_items] = mes_misra_slsf_042_b(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_042_b - A state must contain no more than one default
% transition.
%
% PASS/FAIL CRITERIA:
% ===================
...
function [result, cr_items, r_stats] = mes_misra_slsf_042_b(system,cmd_s)
