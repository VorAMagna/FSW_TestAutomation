% MES check: misra_slsf_050_d - Stateflow window and text appearance
%
% function [result, cr_items] = mes_misra_slsf_050_d(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% Date: $Date: 2020/07/31 16:04:42CEST $
% Version: $Rev: 15479 $
% ***********************************************************

function [result, cr_items, r_stats] = mes_misra_slsf_050_d(system,cmd_s)
