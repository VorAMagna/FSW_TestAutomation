%% Signal and Bus Line Positioning - Branching
%
% [result,cr_items,r_stats]=mes_misra_slsf_029_f(system,cmd_s)
%
% OUTPUT:
% =======
...
% DESCRIPTION:
% ============
% For all signal and bus branching, the mark point of the branching must
...
function [result,cr_items,r_stats] = mes_misra_slsf_029_f(system, cmd_s)
