% misra_slsf_042_e - Default Transitions
%
% function [result, cr_items] = mes_misra_slsf_042_e(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_042_e - Default transitions must not cross state boundaries.
%
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes each default transition in a Stateflow chart.
% Failed: If the default transition crosses state boundaries.
...
function [result, cr_items, r_stats] = mes_misra_slsf_042_e(system,cmd_s)
