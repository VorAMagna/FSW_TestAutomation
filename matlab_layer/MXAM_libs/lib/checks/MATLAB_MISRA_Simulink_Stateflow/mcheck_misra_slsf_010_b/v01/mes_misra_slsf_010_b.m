% MES check: misra_slsf_010_b - Arithmetic operation order of product block.
%
% function [result,cr_items,r_stats] = mes_misra_slsf_010_b(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_slsf_010_b - Arithmetic operation order of product block.
% The first input of product block should be multiply ('*') when the block
% is configured as divider.
%
% FAIL CRITERIA:
% ================
% If the first input of a product block or TL_Product block is not '*', a
% fail will be given.%
% ***********************************************************
...
function [result,cr_items,r_stats] = mes_misra_slsf_010_b(varargin)
