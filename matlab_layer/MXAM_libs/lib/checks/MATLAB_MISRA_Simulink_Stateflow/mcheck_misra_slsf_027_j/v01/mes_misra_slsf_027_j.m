% MES check: mes_misra_slsf_027_j - Signal and bus label usage
%
...
% MES CHECK:
% ==========
% mes_misra_slsf_027_j - Signal and bus label usage
%
% All non-propagated labels must be unique. Exception: Labels inside a
% re-usable subsystem that do not propagate out are exempt from this part
% of the rule
%
% PASS/FAIL CRITERIA:
% ===================
% Check receives a pass, if each signal-label is unique. 
% Propagated signals are ignored as well as signals within a reuseable
% subsystem. 
%
% CHECK PARAMETERS:
% =================
% MISRA_SL_SF.misra_slsf_027_j.BasicMaskedBlocks:
%   DATATYPE: 
%       cellstring
%   DEFAULT VALUE:
%       {''}
...
function [result,cr_items,r_stats]=mes_misra_slsf_027_j(system,cmd_s) %#ok<INUSD>
