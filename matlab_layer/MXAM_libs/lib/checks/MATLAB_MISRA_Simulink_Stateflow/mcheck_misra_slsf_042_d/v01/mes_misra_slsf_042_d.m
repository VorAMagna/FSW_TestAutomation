%% Check: misra_slsf_042_d - Default Transitions
%
% function [result, cr_items] = mes_misra_slsf_042_d(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_042_d - The default transition inside state-charts must have
% an unguarded path to a state.
%
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes ever state-chart:
% Failed: if the default transition in a state-chart does not have an
% unconditioned path to a state.
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
function [result, cr_items, r_stats] = mes_misra_slsf_042_d(system,cmd_s)
