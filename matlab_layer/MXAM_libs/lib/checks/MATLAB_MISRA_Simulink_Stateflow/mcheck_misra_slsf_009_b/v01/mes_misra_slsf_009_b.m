% MES check: misra_slsf_009_b - Block Execution Frequency and Order - Block Priority
% 
% function [result,cr_items,r_stats] =  mes_misra_slsf_009_b(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
%
% Block priority must not be used to specify the block execution order.
%
% The use of block priorities leads to poor model understanding and style 
% since the execution order is no longer transparent.
%
%
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes each block in the model:
% Failed 1: The block priority has been set (it is not empty).
% The check result is passed if all failed cases do not apply.
%
% FIX ACTION:
% ===========
% The automatic repair action removes the priority of the block.
%
% ************************************************************************
...
function [result,cr_items,r_stats] = mes_misra_slsf_009_b(system, cmd_s) %#ok<INUSD>
