% misra_slsf_042_a - Default Transitions
%
% function [result, cr_items] = mes_misra_slsf_042_a(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_slsf_042_a - A super-state containing exclusive states must have exactly one default transition.
%
% PASS/FAIL CRITERIA:
% ===================
% The check analyzes each super-state within a Stateflow chart, i.e. each state which contains other states.
% Failed: If the super-state contains exclusive states and there is no or more than one default transition within the state.
% A check result is passed if the failed case does not apply.
%
% CHECK PARAMETERS:
% =================
% No parameters used.
...
% Date: $Date: 2020/07/31 16:04:31CEST $
% Version: $Rev: 15479 $
% ***********************************************************

function [result, cr_items, r_stats] = mes_misra_slsf_042_a(system,cmd_s)
