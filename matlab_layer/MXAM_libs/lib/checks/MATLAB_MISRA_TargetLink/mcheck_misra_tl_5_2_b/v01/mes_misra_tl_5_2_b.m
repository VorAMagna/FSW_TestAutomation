% MES check: misra_tl_5_2_b - Default output of Switch Case block must be
% properly connected
%
% function [result,cr_items,r_stats] = mes_misra_tl_5_2_b(system,cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_5_2_b - Default output of Switch Case block must be properly
% connected
%
% PASS/FAIL CRITERIA
% ==================
% A fail is given to Switch Case blocks which default output is not
% connected.
% 
%
% ************************************************************************
...
function [result,cr_items,r_stats] = mes_misra_tl_5_2_b(system,cmd_s) %#ok<INUSD>
