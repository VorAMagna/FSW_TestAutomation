% MES check: misra_tl_5_10 - Use of Custom Code blocks
%
% function [result,cr_items,r_stats] = mes_misra_tl_5_10(system, cmd_s)
%
% INPUT PARAMETERS:
% =================
...
% MES CHECK: 
% ==========
% misra_tl_5_10 - Use of Custom Code blocks
%
% The floating-point implementation of a custom code block should always be
% available. Where the option "Use production code for floating-point
% simulation" is checked then the floating-point implementation can be the
% same as the production code implementation.
%
% To allow simulation of both the field and floating point implementations.
%
% PASS/FAIL CRITERIA:
% ===================
% A fail is given to Custom Code blocks where the option 
% "Use production code for floating-point simulation" is not checked
%
%
% ************************************************************************
