% MES check: misra_tl_6_4 - Use of the FIR Filter block for fixed-point
% code generation
%
% function [result,cr_items,r_stats] = mes_misra_tl_6_4(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_6_4 - Use of the FIR Filter block for fixed-point
% code generation
%
% The FIR Filter block should not be used for fixed-point code generation
% if compliance with a maximum number of MISRA C rules is required.
%
% The code for the FIR Filter block is implemented with macros and function
% calls that do not comply with the MISRA C rules listed above.
% Note: This rule does not imply that use of this block (resulting in
% noncompliance with other rules) will necessarily result in unsafe code.
%
% PASS/FAIL CRITERIA:
% ==================
% A FIR Filter block which input and output
% datatype are fixed-point (=int) get a fail, otherwise it will pass. 
%
% ************************************************************************
% copyright:    Model Engineering Solutions
% version:      $Id: mes_misra_tl_6_4.m 1.3 2019/03/29 12:54:18CET Beermann-Steger, Raoul (beermara) Exp  $
% ************************************************************************
