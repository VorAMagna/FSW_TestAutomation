% MES check: misra_tl_4_2 - Permitted Data Types at the Stateflow Chart Interface
%
% function [result,cr_items,r_stats] = mes_misra_tl_4_2(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% PASS/FAIL CRITERIA
% ==================
% A FAIL is given to every Stateflow Chart whose
...
function [result,cr_items,r_stats] = mes_misra_tl_4_2(system, cmd_s) %#ok<INUSD>
