% MES check: misra_tl_5_3 - Use of Data Store blocks across
% TargetLink subsystems
%
% function [result,cr_items,r_stats] = mes_misra_tl_5_3(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_5_3 - Use of Data Store blocks across
% TargetLink subsystems
%
% The Data Store Memory, Data Store Read, and Data Store Write blocks must
% not be used to exchange data across TargetLink subsystems boundaries. In
% addition, they should only be used in those cases where their
% relationship is transparent, for example within the same subsystem.
%
...
% interface variables at the boundary of a TargetLink subsystem must be
% properly defined.
%
% PASS/FAIL CRITERIA
% ==================
% A fail is given to Data Store blocks which are used across the 
% tl-toplevel subsystems boundaries and have the same tags. Otherwise a
% pass is given.
%
%
% ************************************************************************
...
function [result,cr_items,r_stats]=mes_misra_tl_5_3(system,cmd_s) %#ok<INUSD>
