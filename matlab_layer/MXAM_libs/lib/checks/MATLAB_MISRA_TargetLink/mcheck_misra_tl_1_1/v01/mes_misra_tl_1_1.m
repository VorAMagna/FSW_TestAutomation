% MES check: misra_tl_1_1 - Absence of user-specified block priorities
% 
% function [result,cr_items,r_stats] = mes_misra_tl_1_1(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_1_1 - Absence of user-specified block priorities
%
...
% Date:         $Date: 2019/03/29 12:54:14CET $
% Revision:     $Rev: 15194 $
% ************************************************************************

function [result,cr_items,r_stats] = mes_misra_tl_1_1(system, cmd_s) %#ok<INUSD>
