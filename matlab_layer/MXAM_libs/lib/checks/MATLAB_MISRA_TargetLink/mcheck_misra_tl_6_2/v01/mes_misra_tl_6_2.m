% MES check: misra_tl_6_2 - Zero offsets
%
% function [result,cr_items,r_stats] = mes_misra_tl_6_2(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
%
% For fixed-point code generation it is recommended that the block offset
% is set to zero. This can be set in the offset field of the block dialog.
%
% Non-zero offsets for block inputs, outputs, states and parameters lead to
% the generation of additional code and hence to increased code size and execution time.
%
% PASS/FAIL CRITERIA:
% ===================
% A fail is given to TargetLink blocks which offset is not set to zero.
%
