% MES check: misra_tl_7_5 - Avoiding local macros.
%
% function [result,cr_items,r_stats] = mes_misra_tl_7_5(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK:
% ==========
% misra_tl_7_5 - Avoiding local macros
% Local macros should not be used in TargetLink model. 
% TargetLink generates #defines and #undef preprocessor diectives for local
% macros. This violates rules 19.5 and 19.6.
%
% PASS/FAIL CRITERIA:
% ===================
% A fail is given to each TargetLink block, whose property *.class
% (gain.class, out.class...) is not empty and the entry 'Macro' is 'on', 
% the entry 'scope' is 'local' and 'storage' is not 'extern'.
%
