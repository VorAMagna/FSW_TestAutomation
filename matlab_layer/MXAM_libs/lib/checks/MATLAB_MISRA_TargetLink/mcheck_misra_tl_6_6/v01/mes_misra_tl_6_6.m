% MES check: misra_tl_6_6 - Use of custom Lookup table functions
%
% function [result,cr_items,r_stats] = mes_misra_tl_6_6(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_6_6 - Use of custom Lookup table functions
%
% Advice: Custom Lookup table code should be implemented instead of TargetLink
% Lookup table code if compliance with a maximum number of MISRA C rules is
% required.
%
% Note:This rule does not imply that the use of TargetLink Lookup table
% blocks (resulting in noncompliance with the above rules) will result in
% unsafe code.
%
% PASS/FAIL CRITERIA:
% ===================
% The Check failes if a TargetLink Lookup-Table is used in the
% model.
%
% ***********************************************************
