% MES check: misra_tl_7_1 - Generating generic code without pragmas
%
% function [result,cr_items,r_stats] = mes_misra_tl_7_1(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
%
% For C code generation according to ISO/IEC 9899:1990, the "Assembler and 
% C extensions" and "Enable sections/pragmas/inline/ISR/user attributes"
% should not be selected.
%
% Note: It is recognized that it will be necessary to raise deviations to
% this rule, for example to support compiler/hardware specific features.
%
% PASS/FAIL CRITERIA:
% ===================
% A pass is given to targetlink main dialog block which
% option "Assembler and C extensions" and 
% "Enable sections/pragmas/inline/ISR/user attributesis" are cleared. 
% Otherwise, it receives a Fail.
%
% FIX ACTION:
% ===========
% The option "Assembler and C extensions"  and 
% "Enable sections/pragmas/inline/ISR/user attributesis" will be cleared.
%
