% MES check: misra_tl_4_4 - Avoidance of Saturation in Integer Arithmetic
%
% function [result,cr_items,r_stats] = mes_misra_tl_4_4(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_4_4 - Avoidance of Saturation in Integer Arithmetic
%
...
%
% Implementation specific aspects like saturation in integer arithmetic
% operations have to be handled at the code level. Moreover, the semantics
% on how saturation is performed in integer arithmetic in Simulink is 
% non-transparent and block-specific. The inputs of a sum block for 
% instance, are directly cast to the output type and potentially saturated
% just like any other intermediate result. This can lead to differences in
% behaviour between Simulink and TargetLink.
%
% PASS/FAIL CRITERIA
% ==================
% Every block which uses saturation in integer arithmatics via the
% 'Saturate on Integer overflow' option failes.
%
% FIX ACTION:
% ================ 
