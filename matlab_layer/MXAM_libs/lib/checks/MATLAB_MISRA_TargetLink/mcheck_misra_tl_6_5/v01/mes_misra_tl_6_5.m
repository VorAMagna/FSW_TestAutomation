% MES check: misra_tl_6_5 - Use of Trigonometric functions for fixed-point
% code generation
%
...
% MES CHECK: 
% ==========
% misra_tl_6_5 - Use of Trigonometric functions for fixed-point
% code generation
%
% Trigonometric functions should not be used for fixed-point code
% generation if compliance with a maximum number of MISRA C rules is
% reqired.
%
% The Trigonometric functions violate a number of MISRA rules when used for
% fixed-point code generation so they should be avoided.
...
% PASS/FAIL CRITERIA:
% ==================
% A Trigonometric function block which input and output
