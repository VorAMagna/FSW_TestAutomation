% MES check: misra_tl_7_9 - Avoiding shift operations on signed types
%
% function [result,cr_items,r_stats] = mes_misra_tl_7_9(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_7_9 - Avoiding shift operations on signed types
%
% The TargetLink option ShiftMode can be used to suppress shift operations
% (<< and >>) and instead replace them with multiplications and divisions
%
% By default, TargetLink tries to implement shift operations instead of
% multiplications and divisions. This makes the generated production code
% more efficient. However this violates MISRA C Rule 12.7 if the underlying
% type of the operands is signed. The ShiftMode option can be used to 
% suppress shift operators in the generated code.
%
% PASS/FAIL CRITERIA:
% ===================
% A fail is given to TargetLink Main Dialog blocks in which settings the ShiftMode 
% is not set to 'dont shift at all'.
%
% ************************************************************************
