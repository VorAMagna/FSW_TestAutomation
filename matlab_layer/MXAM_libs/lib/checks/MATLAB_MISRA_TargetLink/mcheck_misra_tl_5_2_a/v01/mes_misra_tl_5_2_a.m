% MES check: misra_tl_5_2_a - Show Default Case option of Switch Case block should be set
%
% function [result,cr_items,r_stats] = mes_misra_tl_5_2_a(system,cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% misra_tl_5_2_a - Show Default Case option of Switch Case block should be
% set
%
% All switch case instructions in the generated code should have 
% a default clause to catch any undefined states during program execution.   
%
% PASS/FAIL CRITERIA
% ==================
% A fail is given to Switch Case blocks which option "Show default case"
% is not set.
%
% FIX ACTION:
% ===========
...
function [result,cr_items,r_stats] = mes_misra_tl_5_2_a(system,cmd_s) %#ok<INUSD>
