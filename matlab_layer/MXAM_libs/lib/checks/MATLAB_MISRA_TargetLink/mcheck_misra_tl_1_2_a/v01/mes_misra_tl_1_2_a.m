% MES check: misra_tl_1_2_a - Comments in Block Properties
%
% function [result,cr_items,r_stats] = mes_misra_tl_1_2_a(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% All comments provided should be valid ANSI C comments without the
% enclosing /* and */ symbols. In particular, this rules out the use 
% of /* and */ . The rule ensures that comments on the block level can be 
% transformed into valid C comments.
%
% 
% Pass CRITERIA:
% ===================
% A pass is given if the descriptions of a block and the descriptions in
% the DD of the variables used in the model do not include the strings /*
% and */ .
%
% SOLUTION:
% =========
...
function [result,cr_items,r_stats] = mes_misra_tl_1_2_a(system, cmd_s) %#ok<INUSD>
