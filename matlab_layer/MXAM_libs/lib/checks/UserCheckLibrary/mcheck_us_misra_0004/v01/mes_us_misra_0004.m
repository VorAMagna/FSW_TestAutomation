...
function[result,cr_items,r_stats]=mes_us_misra_0004(system,cmd_s)			% type before the id the keyword mes_
[reg,s_regerr]=mxam_getCheckInfoFromDB('us_misra_0004');  					% get defaults from db
                ...
                if ~isSfObj
                    ...
                    if isVolatile
                        it=mxam_newcritem(default_item,...
                            'message',['At the source port ',num2str(i2),' of the logical block ',bName,...
                        ...
                        if ~isSfObj
                            ...
                            if isVolatile
                                ...
                                if ~strcmp(outputClass,'NON_ERASABLE_LOCAL')
                                    it=mxam_newcritem(default_item,...
                                        'message',['The output class of the relational operator ',relOpName,...
