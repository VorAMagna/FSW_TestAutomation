...
function[result,cr_items,r_stats]=mes_us_misra_0003(system,cmd_s)			% type before the id the keyword mes_
[reg,s_regerr]=mxam_getCheckInfoFromDB('us_misra_0003');  					% get defaults from db
