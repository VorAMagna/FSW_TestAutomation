% MES check: ds_0022 - Restrictions with regard to the use of blocks from
% the discrete library.
%
% function [result,cr_items,r_stats] = mes_ds_0022(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% ds_0022 - Restrictions with regard to the use of blocks from the
% discrete library.
%
% This check tests if only allowed block of discrete library is used in
% model.
%
% Rationale:
...
% PASS/FALL CRITERIA:
% ================
% A pass is given if no block of discrete library, except the blocks
...
% CHECK PARAMETERS:
% =================
% dSPACE.checkds0022.BeingCheckedSLLib:
%   DATATYPE: 
%       string
%   DEFAULT VALUE:
%       'simulink/Discrete'
...
% 
% dSPACE.checkds0022.AllowedBlocks:
%   DATATYPE: 
%       cellstring
%   DEFAULT VALUE:
...
%        ['simulink/Discrete/Zero-Order' char(10) 'Hold']}
%   DESCRIPTION:
...
function [result,cr_items,r_stats] = mes_ds_0022(varargin)
