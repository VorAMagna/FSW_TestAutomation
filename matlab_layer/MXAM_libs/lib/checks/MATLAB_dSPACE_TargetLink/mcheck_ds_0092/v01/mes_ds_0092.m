% Check: ds_0092 - Solver Settings
%
% function [result,cr_items,r_stats] = mes_ds_0092(system, cmd_s)
%
% INPUT PARAMETERS:
% =================
...
function [result,cr_items,r_stats]=mes_ds_0092(system,cmd_s) %#ok<INUSD>
