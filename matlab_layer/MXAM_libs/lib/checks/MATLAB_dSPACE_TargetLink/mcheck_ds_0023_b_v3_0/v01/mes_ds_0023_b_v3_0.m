% MES check: ds_0023_b_v3_0 -  Limitations with Regard to the Discrete-Time
%                       Integrator Block
%
% function [result,cr_items,r_stats] = mes_ds_0023_b_v3_0(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% ds_0023_b_v3_0 -  Limitations with Regard to the Discrete-Time Integrator Block
% 
