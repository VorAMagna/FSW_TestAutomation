% MES check: ds_0039 - Restrictions with regard to the use of blocks from
% the signal attributes library.
%
% function [result,cr_items,r_stats] = mes_ds_0039(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% ds_0039 - Restrictions with regard to the use of blocks from the
% signal attributes library.
%
% This check tests if only allowed block of signal attributes library is used in
% model.
%
% Rationale:
...
% PASS/FALL CRITERIA:
% ================
% A pass is given if no block of signal attributes library, except the blocks
% given in the parameter dSPACE.checkds0039.AllowedBlocks, is used,
% otherwise fail is given.
%
% Note: The blocks listet in dSPACE.checkds0039.AllowedBlocks must exactly
% be the same as the corresponding block in the library (i.e. including
% linebreaks, spaces)
% 
% CHECK PARAMETERS:
% =================
% dSPACE.checkds0039.BeingCheckedSLLib:
%   DATATYPE: 
%       string
%   DEFAULT VALUE:
...
% 
% dSPACE.checkds0039.AllowedBlocks:
%   DATATYPE: 
%       cellstring
%   DEFAULT VALUE:
%       {['simulink/Signal' char(10) 'Attributes/Data Type Conversion'];...
%        ['simulink/Signal' char(10) 'Attributes/Rate Transition']}
%   DESCRIPTION:
...
function [result,cr_items,r_stats] = mes_ds_0039(varargin)
