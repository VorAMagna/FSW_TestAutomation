% MES check: ds_0024 - Restrictions with regard to the use of blocks from
% the logic and bit operations library.
%
% function [result,cr_items,r_stats] = mes_ds_0024(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% ds_0024 - Restrictions with regard to the use of blocks from the
% logic and bit operations library.
%
% This check tests if only allowed block of logic and bit operations
% library is used in model.
%
% Rationale:
% TargetLink supports only a restricted subset of blocks to ensure the
% generation of efficient code. The Bitwise Operator is not a built-in
% TargetLink Block but realized using a Custom Code block.
%
% PASS/FALL CRITERIA:
% ================
% A pass is given if no block of logic and bit operations library, except
% the blocks given in the parameter dSPACE.checkds0024.AllowedBlocks, is
% used, otherwise fail is given.
%
% Note: The blocks listet in dSPACE.checkds0024.AllowedBlocks must exactly
% be the same as the corresponding block in the library (i.e. including
% linebreaks, spaces)
% 
% CHECK PARAMETERS:
% =================
% dSPACE.checkds0024.BeingCheckedSLLib:
%   DATATYPE: 
%       string
%   DEFAULT VALUE:
...
% 
% dSPACE.checkds0024.AllowedBlocksPrior31:
%   DATATYPE: 
%       cellstring
%   DEFAULT VALUE:
%       {['simulink/Logic and Bit' char(10) 'Operations/Bitwise' char(10) 'Operator'];...
...
% dSPACE.checkds0024.AllowedBlocksAfter31:
%   DATATYPE: 
%       cellstring
%   DEFAULT VALUE:
%       {['simulink/Logic and Bit' char(10) 'Operations/Bitwise' char(10) 'Operator'];...
...
%        ['simulink/Logic and Bit' char(10) 'Operations/Shift' char(10) 'Arithmetic']
%
%   DESCRIPTION:
...
function [result,cr_items,r_stats] = mes_ds_0024(varargin)
