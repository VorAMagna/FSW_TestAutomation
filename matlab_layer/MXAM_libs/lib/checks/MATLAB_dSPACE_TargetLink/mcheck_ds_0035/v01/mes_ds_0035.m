% MES check: ds_0035 - Restrictions with regard to the use of blocks from
% the model-wide utilities library.
%
% function [result,cr_items,r_stats] = mes_ds_0035(system, cmd_s)
%
% RETURN PARAMETERS:
% ==================
...
% MES CHECK: 
% ==========
% ds_0035 - Restrictions with regard to the use of blocks from the
% model-wide utilities library.
%
% This check tests if only allowed block of model-wide utilities library is used in
% model.
%
% Rationale:
% TargetLink supports only a restricted subset of blocks.
%
% PASS/FALL CRITERIA:
% ================
% A pass is given if no block of model-wide utilities library, except the blocks
% given in the parameter dSPACE.checkds0035.AllowedBlocks, is used,
% otherwise fail is given.
%
% Note: The blocks listet in dSPACE.checkds0035.AllowedBlocks must exactly
% be the same as the corresponding block in the library (i.e. including
% linebreaks, spaces)
% 
% CHECK PARAMETERS:
% =================
% dSPACE.checkds0035.BeingCheckedSLLib:
%   DATATYPE: 
%       string
%   DEFAULT VALUE:
...
% 
% dSPACE.checkds0035.AllowedBlocks:
%   DATATYPE: 
%       cellstring
%   DEFAULT VALUE:
%       {['simulink/Model-Wide' char(10) 'Utilities/Block Support' char(10) 'Table'];...
%        ['simulink/Model-Wide' char(10) 'Utilities/Model Info'];...
%        ['simulink/Model-Wide' char(10) 'Utilities/DocBlock']}
%   DESCRIPTION:
...
function [result,cr_items,r_stats] = mes_ds_0035(varargin)
